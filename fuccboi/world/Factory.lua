...
function Factory:createEntityImmediate(type, x, y, settings)
    if self.fg.classes[type].pool_enabled then
        ...
        local entity = self.fg.classes[type](self, x, y, settings)
        return entity 
    end
end
...
function Factory:poolCreateEntity(type, x, y, settings)
    ...
    if entity then
        ...
        self:addToLayer(self.fg.classes[type].layer or 'Default', entity)
    end
    return entity
end
        ...
        if o.type then 
            if self.fg.classes[o.type].pool_enabled then
                ...
                if entity then
                    ...
                    self.fg.world:addToLayer(self.fg.classes[o.type].layer or 'Default', entity)
                end
            end
        end
    end
