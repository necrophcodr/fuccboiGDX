...
function Pool:new(world, name, size, overflow_rule)
    self.world = world
    self.name = name
    self.size = size
    ...
    for i = 1, self.size do
        self.objects[i] = {object = self.world:poolCreateEntity(name, -100000, -100000), in_use = false, last_time = love.timer.getTime()}
    end
end
