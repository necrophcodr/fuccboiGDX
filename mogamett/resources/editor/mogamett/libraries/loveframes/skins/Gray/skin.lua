...
local default_font = loveframes.config["DIRECTORY"] .. "/skins/" .. skin.name .. "/SourceSansPro-Regular.otf"

local smallfont = love.graphics.newFont(default_font, 12)
local imagebuttonfont = love.graphics.newFont(default_font, 14)
local bordercolor = {64, 64, 64, 255}

-- hack to replace input and text default font
loveframes.basicfontsmall = smallfont
loveframes.smallfont = smallfont
...
-- menu
skin.controls.menu_body_color                       = {110, 110, 110, 255}

-- menuoption
skin.controls.menuoption_body_hover_color           = {83, 83, 83, 255}
skin.controls.menuoption_text_hover_color           = {255, 255, 255, 255}
skin.controls.menuoption_text_color                 = {230, 230, 230, 255}
...
skin.controls.checkbox_check_color                  = {200, 200, 200, 255}
